    ...
    <div className="p-4 md:p-[7em]">
        ...
        <div className="mt-6 mb-3">
            ...
            <p className="text-[18px] lg:text-[22px] font-[family-name:var(--font-geist-lora)] font-[500] w-full lg:w-2/5">
              I’m a Software Engineer and a Technology Entreprenuer based in Lagos, Nigeria, with a passion for building software solutions, crafting compelling stories, exploring new places, and honing my French-speaking skills.
            </p>
            <SocialMediaIcons />
        </div>
